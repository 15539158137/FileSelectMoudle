...
public class FolderDataFragment extends Fragment {
    ...
    private void initData() {
        ...
        final FolderDataRecycleAdapter pptListAdapter = new FolderDataRecycleAdapter(getActivity(), data, isImage);
        rvDoc.setAdapter(pptListAdapter);
        pptListAdapter.setOnItemClickListener(new FolderDataRecycleAdapter.OnItemClickListener() {
            @Override
