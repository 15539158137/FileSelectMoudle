...
public class FolderDataRecycleAdapter extends RecyclerView.Adapter<FolderDataRecycleAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                onItemClickListener.onClickItem((Integer) view.getTag());
            }
        });
        ...
        if (data.get(position).isChoosed()) {
            holder.image_choosed.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.choosed));
        } else {
            holder.image_choosed.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.nochoosed));
        }
        //封面图
        if (isPhoto) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            image_choosed = itemView.findViewById(R.id.image_choosed);
        }
    }
